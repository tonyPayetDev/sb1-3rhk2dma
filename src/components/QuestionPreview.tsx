...
export function QuestionPreview({
  ...
  useEffect(() => {
    ...
    const randomBackground =
      PEXELS_BACKGROUNDS[Math.floor(Math.random() * PEXELS_BACKGROUNDS.length)];
  ...
  return (
    <div
    className="aspect-[9/16] rounded-lg shadow-lg p-8 flex flex-col justify-center bg-cover bg-center relative overflow-hidden"
    style={{
      backgroundImage: `url(${backgroundImage})`,
      backgroundSize: "contain",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
      width: "37%", // ✅ Largeur adaptée
      height: "39%", // ✅ Hauteur adaptée
      maxHeight: "100vh", // ✅ Empêche les débordements
    }}
  >
    ...
    />
      ...
      <div className="relative z-10">
            ...
            return (
              <button
                ...
                style={{
                  backgroundColor,
                  border: `2px solid ${
                    showResult && isCorrect ? "#22c55e" : style.accentColor
                  }`,
                  color: style.textColor,
        ...
        <div
          ...
          style={{ color: `${style.textColor}b3` }}
        >
